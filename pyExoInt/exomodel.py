...
def exomodel(
    ...
    filename = stellar_abundances_file.split("/")[-1]
   ...
   # mantle_df["N_val"] = mantle_Nval_P
    ...
    file = open(outdir + filename + "_results_formated.txt", "w")
    ...
    results_df.to_csv(outdir + filename + "_results.csv")
