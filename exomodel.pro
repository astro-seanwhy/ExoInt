...
readcol, 'outputs/devolmodel_lin_pattern.txt', F='x,f,f,f', ymodelN, ymodelNsdup, ymodelNsddn
readcol, 'outputs/devolmodel_log_pattern.txt',  F='x,f,f,f', ymodellog, ymodeldexsdup, ymodeldexsddn
;; ENDELSE
