Function exomodel, stardex, stardexerr, starlable=starlable
;;;;DO NOT MODIFY THIS CODE, WITHOUT THE PERMISION OF THE CREATER
...
ymodelN(where(ymodelN eq -11, /null))=nan
ymodelNsdup(where(ymodelNsdup eq -11, /null))=nan
ymodelNsddn(where(ymodelNsddn eq -11, /null))=nan
;
ymodellog(where(ymodellog eq -11, /null))=nan
ymodeldexsdup(where(ymodeldexsdup eq -11, /null))=nan
ymodeldexsddn(where(ymodeldexsddn eq -11, /null))=nan
