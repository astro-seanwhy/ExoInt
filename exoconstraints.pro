...
Result_proto=exomodel(solardexnorm, solardexnormerr, starlable=starlable)
;stop

starlable='K10' ;; All good
Result_k10=exomodel(K10HETdex, K10HETdexerr, starlable=starlable)
;stop

starlable='K20' ;; Star's O is starved
Result_k20=exomodel(K20dex, K20dexerr, starlable=starlable)
;stop

starlable='K21' ;; NO S
Result_k21=exomodel(K21dex, K21dexerr, starlable=starlable)
;stop

starlable='K100' ;; All good
Result_k100=exomodel(K100dex, K100dexerr, starlable=starlable)
